...
export type Project = {
  ...
  uses: { title: string; desc: string; img: typeof IMG.exterior }[];
...
const SHARED_USES: Project["uses"] = [
  { title: "First Home Buyers", desc: "Sized for a young family, with room to grow into rather than out of.", img: IMG.family },
  { title: "Growing Families", desc: "Plans with a separate study or third bedroom, and storage where a household actually needs it.", img: IMG.interior },
  { title: "Multi-Generational", desc: "Ground-floor and lift-adjacent units suited to older parents, with step-free access from the parking level.", img: IMG.community },
  { title: "Investors", desc: "Entry backed by a fifteen-year delivery record and steady rental demand across the corridor.", img: IMG.night },
];
...
export const PROJECTS: Project[] = [
  {
    ...
    configs: [
      { title: "2 BHK · Park facing", tag: "2 BHK", desc: "Every 2 BHK is park-facing, planned for cross ventilation and morning light with a kitchen that sees the living room.", img: IMG.park },
      { title: "3 BHK · Corner unit", tag: "3 BHK", desc: "A separate study or third bedroom, and storage where a household actually needs it. Corner units available with extra windows.", img: IMG.interior },
    ],
  ...
  },
  {
    ...
    configs: [
      { title: "2 BHK · Courtyard facing", tag: "2 BHK", desc: "Park and courtyard-facing 2 BHK homes planned for cross ventilation and morning light.", img: IMG.park },
      { title: "3 BHK · Corner unit", tag: "3 BHK", desc: "Corner 3 BHK plans with a study or third bedroom and storage for a household.", img: IMG.interior },
    ],
  ...
  },
  {
    ...
    configs: [
      { title: "2 BHK · Park facing", tag: "2 BHK", desc: "Ready to move into, with the finishes and balconies you can inspect in person today.", img: IMG.park },
      { title: "3 BHK · Corner unit", tag: "3 BHK", desc: "Corner 3 BHK plans ready to occupy, with a study or third bedroom.", img: IMG.interior },
    ],
  ...
  },
  {
    ...
    configs: [
      { title: "2 BHK · Park facing", tag: "2 BHK", desc: "Occupied 2 BHK homes, planned for cross ventilation and morning light.", img: IMG.park },
      { title: "3 BHK · Corner unit", tag: "3 BHK", desc: "Corner 3 BHK plans with a study or third bedroom, occupied and lived in.", img: IMG.interior },
    ],
  ...
  },
  {
    ...
    configs: [
      { title: "2 BHK · Park facing", tag: "2 BHK", desc: "The original 2 BHK homes, planned for cross ventilation and morning light.", img: IMG.park },
      { title: "3 BHK · Corner unit", tag: "3 BHK", desc: "Corner 3 BHK plans with a study or third bedroom.", img: IMG.interior },
    ],
