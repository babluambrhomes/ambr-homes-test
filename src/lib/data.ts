...
export const CONTACT = {
  ...
  officeHours: "Open 10am â€” 7pm, every day including Sundays.",
  ...
  rera:
    "RERA registration numbers â€” Ambrosia: UPRERAPRJXXXXXX Â· Atlanta: UPRERAPRJXXXXXX Â· Amore: UPRERAPRJXXXXXX Â· Magnolia: UPRERAPRJXXXXXX Â· Aspire: UPRERAPRJXXXXXX. Available at up-rera.in. Images and plans on this page are indicative. Nothing on this website constitutes an offer or contract; all bookings are governed by the agreement for sale executed between the parties.",
};
...
const SHARED_TECH = [
  ...
  { title: "Waterproofing", desc: "Membrane treatment to terraces, balconies and wet areas â€” tested before the finishes go on, not after." },
...
const SHARED_STEPS = [
  ...
  { title: "Snagging & Handover", desc: "A snag list is walked with you, closed out, and only then are the keys handed over â€” with maintenance support that continues afterwards." },
];
...
const COMPLETED_FAQS = [
  ...
  },
  {
    ...
    a: "Yes, and we would encourage it. The flats are ready to walk through â€” stand in the actual home, on the actual balcony, before committing to anything.",
  },
  {
  ...
  },
  {
    ...
    a: "A snag list is walked with you before handover and closed out afterwards. Maintenance is handed over to the resident association with our team supporting the transition, and the same site office stays reachable â€” buyers from our earliest project still call it.",
  },
];
...
export const PROJECTS: Project[] = [
  {
    ...
    statusLabel: "Under Construction Â· Pre-booking",
    statusTone: "orange",
    locality: "Vaidpura",
    ...
    intro:
      "Wider balconies, larger kitchens and a park edge that most homes look directly onto. Aspire is designed for families buying their second home â€” not their first compromise. Now open for pre-booking in Vaidpura, Greater Noida West.",
    configs: [
      { title: "2 BHK Â· Park facing", tag: "2 BHK", desc: "Every 2 BHK is park-facing, planned for cross ventilation and morning light with a kitchen that sees the living room.", img: { src: "https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?auto=format&fit=crop&w=1600&q=80", alt: "Park-facing home at Ambr Homes" } },
      { title: "3 BHK Â· Corner unit", tag: "3 BHK", desc: "A separate study or third bedroom, and storage where a household actually needs it. Corner units available with extra windows.", img: { src: "/images/hero-4.jpeg", alt: "Finished living room at an Ambr Homes flat" } },
    ],
    ...
    benefits: [
      ...
      { title: "Landscape held in the plan", desc: "Planting, play courts and the walking loop are part of the sanctioned drawing â€” not an amenity that quietly shrinks as the project is value-engineered." },
    ...
    finalBody: "Best floors and corner units go first. Tell us what you are looking for and we will send the sanctioned layout, the payment schedule and the RERA filing before you visit â€” so the site visit is about the building, not the paperwork.",
  },
  {
    slug: "magnolia",
    name: "Magnolia",
    ...
    configs: [
      { title: "2 BHK Â· Courtyard facing", tag: "2 BHK", desc: "Park and courtyard-facing 2 BHK homes planned for cross ventilation and morning light.", img: { src: "https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?auto=format&fit=crop&w=1600&q=80", alt: "Park-facing home at Ambr Homes" } },
      { title: "3 BHK Â· Corner unit", tag: "3 BHK", desc: "Corner 3 BHK plans with a study or third bedroom and storage for a household.", img: { src: "/images/hero-4.jpeg", alt: "Finished living room at an Ambr Homes flat" } },
    ],
    ...
    whyRows: [
      ...
      { h: "The Magnolia approach", p: "Courtyards, planting and the walking loop are fixed in the sanctioned plan before the homes are drawn around them â€” so the ground you are sold stays." },
    ],
    benefits: [
      ...
      { title: "Balconies you can use", desc: "Deep enough for two chairs and a table â€” not a ledge that every family discovers in the first week." },
    ...
    faqs: [
      ...
      { q: "Can I see the site while it is under construction?", a: "Yes, and we also suggest visiting Ambrosia or Atlanta â€” occupied for years and more revealing about how our buildings age." },
  ...
  },
  {
    ...
    intro:
      "Amore is complete and ready to occupy. Stand in the actual flat and on the actual balcony before committing â€” the most useful visit if you want to see exactly what you are buying.",
    configs: [
      { title: "2 BHK Â· Park facing", tag: "2 BHK", desc: "Ready to move into, with the finishes and balconies you can inspect in person today.", img: { src: "https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?auto=format&fit=crop&w=1600&q=80", alt: "Park-facing home at Ambr Homes" } },
      { title: "3 BHK Â· Corner unit", tag: "3 BHK", desc: "Corner 3 BHK plans ready to occupy, with a study or third bedroom.", img: { src: "/images/hero-4.jpeg", alt: "Finished living room at an Ambr Homes flat" } },
    ],
    ...
    benefits: [
      { title: "Move in now", desc: "Amore is complete and ready to occupy â€” no wait for construction." },
      ...
      { title: "Balconies you can use", desc: "Deep enough for two chairs and a table â€” check them in person." },
    ...
    finalBody: "Come and stand in a finished Ambr home. Pick a time â€” evenings and Sundays included â€” and we will keep the flat open.",
  },
  {
    slug: "atlanta",
    name: "Atlanta",
    ...
    intro:
      "Atlanta has been complete and occupied for years â€” the more useful visit if you want to see how our buildings age. Registered with UP RERA, delivered on the date we gave at booking.",
    configs: [
      { title: "2 BHK Â· Park facing", tag: "2 BHK", desc: "Occupied 2 BHK homes, planned for cross ventilation and morning light.", img: { src: "https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?auto=format&fit=crop&w=1600&q=80", alt: "Park-facing home at Ambr Homes" } },
      { title: "3 BHK Â· Corner unit", tag: "3 BHK", desc: "Corner 3 BHK plans with a study or third bedroom, occupied and lived in.", img: { src: "/images/hero-4.jpeg", alt: "Finished living room at an Ambr Homes flat" } },
    ],
    ...
    whyRows: [
      ...
      { h: "Twelve years of evidence", p: "The families at Atlanta have lived with our waterproofing, lifts and fittings for years â€” the only builder review that means anything." },
    ],
    benefits: [
    ...
    finalBody: "Come and stand inside a building we handed over years ago. Pick a time â€” evenings and Sundays included â€” and we will keep the flat open.",
  },
  {
    slug: "ambrosia",
    name: "Ambrosia",
    ...
    intro:
      "Ambrosia was our first community, delivered in 2010 and complete and occupied for years. Its families are still a short drive from our office â€” proof that we build to stay.",
    configs: [
      { title: "2 BHK Â· Park facing", tag: "2 BHK", desc: "The original 2 BHK homes, planned for cross ventilation and morning light.", img: { src: "https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?auto=format&fit=crop&w=1600&q=80", alt: "Park-facing home at Ambr Homes" } },
      { title: "3 BHK Â· Corner unit", tag: "3 BHK", desc: "Corner 3 BHK plans with a study or third bedroom.", img: { src: "/images/hero-4.jpeg", alt: "Finished living room at an Ambr Homes flat" } },
    ],
    ...
    benefits: [
      { title: "Built to last", desc: "Structurally, financially and in daily use â€” for the families who bought here." },
    ...
    finalBody: "Come and see where Ambr began. Pick a time â€” evenings and Sundays included â€” and we will keep the flat open.",
  },
];
